...
const initialData = [
  ...
  },
  {
    ...
    interested in horror villains with some humanity to them, or at least some flavor in their
  ...
  },
  {
    ...
    "release_year": 2008,
    "ranking": 4.5,
    "review": `I absolutely love The Hunger Games series, it's probably both my favorite dystopian movie 
  ...
  },
  {
    ...
    in this book is excellent, and the twists in this entry make for some of the very best in the series. If you've seen the movie before, reading this book is a must, as Suzanne Collins' writing
    is at its peak here and only furthers your immersion in this dystopian world. Now that The Ballad of Songbirds and Snakes is out, I honestly can't say which book I prefer, which I know will be 
    divisive since this book is often regarded as the best in the series. In either case, I would
  ...
  },
  {
    ...
    isn't the point of this entry. By this point, Panem is in an all-out war with the districts and the
    focus of the story becomes on overthrowing the capital and dealing with the ramifications of 
    ...
    world she has been building thus far. The shift away from the games and to the war between the 
  ...
  },
  {
    ...
    issues and lays the groundwork for the rest of the series, where you get to witness Hiccup grow 
...
const initializeFirestore = async () => {
  ...
  for (const review of initialData) {
    ...
    try {
      await addDoc(reviewsCollection, reviewWithUser); // use addDoc to automatically generate a unique ID
      console.log(`Added review for ${review.title}`);
    }
    catch (error) {
      console.error(`Error adding review for ${review.title}: ${error}`);
    }
  }
};
